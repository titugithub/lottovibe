...
add_filter('site_transient_update_plugins', function ($value) {
    if (isset($value) && is_object($value)) {
        // Specify the plugin file to disable update notifications
        $plugin_file = 'lottery-for-woocommerce/lottery-for-woocommerce.php';

        // Remove update notification for the specified plugin
